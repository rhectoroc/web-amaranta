  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center gap-10 py-20 px-4">
        ...
        <div className="filters-text text-center max-w-4xl flex flex-col gap-8">
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`filters-btn flex items-center gap-2 px-4 py-3 md:py-2.5 rounded-full text-xs font-bold transition-all shrink-0 snap-start active:scale-95 border shadow-sm ${
                  isActive
